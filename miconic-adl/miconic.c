...

{
  ...
  printf("-u <num>    percentage of up_down s (preset: %d)\n", gp_up_down);
  printf("-v <num>    percentage of vip s (preset: %d)\n", gp_vip);
  printf("-g <num>    percentage of going_nonstop s (preset: %d)\n", gp_going_nonstop);
  printf("-a <num>    percentage of attendant s (preset: %d)\n", gp_attendant);
  printf("-n <num>    percentage of never_alone s (preset: %d)\n", gp_never_alone);
  printf("-A <num>    percentage of conflict_A s (preset: %d)\n", gp_con_A);
...

{
  ...
  while ( --argc && ++argv ) {
	...
	case 'p':
	  ...
	  break;
	case 'u':
	  sscanf( *argv, "%d", &gp_up_down );
	  break;
	case 'v':
	  sscanf( *argv, "%d", &gp_vip );
	  break;
	case 'g':
	  sscanf( *argv, "%d", &gp_going_nonstop );
	  break;
	case 'a':
	  sscanf( *argv, "%d", &gp_attendant );
	  break;
	case 'n':
	  sscanf( *argv, "%d", &gp_never_alone );
	  break;
	case 'A':
	  sscanf( *argv, "%d", &gp_con_A );
	  break;
	case 'B':
	  sscanf( *argv, "%d", &gp_con_B );
	  break;
	case 'N':
	  sscanf( *argv, "%d", &gp_no_access );
	  break;
	case 'F':
