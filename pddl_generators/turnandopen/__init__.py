...
parser.add_argument("n", type=int, help="the number of robots (minimal 1)")
parser.add_argument("r", type=int, help="the number of rooms (minimal 1)")
parser.add_argument("o", type=int, help="the number of balls (minimal 1)")


def main(args : argparse.Namespace, args2 : argparse.Namespace):

    with open(args.output, mode="w") as f:
        run(args,list(map(str,[rel("turnandopen"),
                               "-n", args2.n,
                               "-r", args2.r,
                               "-o", args2.o,
                               "-s", args.seed])),
