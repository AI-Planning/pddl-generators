...
parser.add_argument("cocktails", type=int)
parser.add_argument("ingredients", type=int)
parser.add_argument("shots", type=int)

def main(args : argparse.Namespace, args2 : argparse.Namespace):

    with open(args.output, mode="w") as f:
        run(args,list(map(str,["python3", rel("barman-generator.py"), *args.rest, args.seed])),
            stdout=f)
