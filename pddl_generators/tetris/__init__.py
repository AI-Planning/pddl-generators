...
parser.add_argument("rows", type=int, help="the number of ")
parser.add_argument("block_type", type=int, choice=[1,2,3,4], help="the number of ")


def main(args : argparse.Namespace, args2 : argparse.Namespace):

    with open(args.output, mode="w") as f:
        run(args,list(map(str,["python3", rel("generator.py"), args2.rows, args2.block_type, args.seed])),
            stdout=f)
