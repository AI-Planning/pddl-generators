...
parser.add_argument("curbs", type=int, help="the number of curbs")
parser.add_argument("cars", type=int, help="the number of cars")


def main(args : argparse.Namespace, args2 : argparse.Namespace):

    with open(args.output, mode="w") as f:
        run(args,list(map(str,[rel("parking-generator.pl"), "parking-problem", args2.curbs, args2.cars, "seq", args.seed])),
            stdout=f)
