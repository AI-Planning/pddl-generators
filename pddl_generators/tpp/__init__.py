...
parser.add_argument("markets", type=int, help="the number of ")
parser.add_argument("products", type=int, help="the number of ")
parser.add_argument("trucks", type=int, help="the number of ")
parser.add_argument("depots", type=int, help="the number of ")
parser.add_argument("goods", type=int, help="the number of ")


def main(args : argparse.Namespace, args2 : argparse.Namespace):

    with open(args.output, mode="w") as f:
        run(args,list(map(str,[rel("tpp"), "-s", args.seed, "-m", args2.markets, "-p", args2.products, "-t", args2.trucks, "-d", args2.depots, "-l", args2.goods,])),
            stdout=f)
