...
parser.add_argument("roadjunctions", type=int, help="")
parser.add_argument("drivers", type=int, help="")
parser.add_argument("packages", type=int, help="")
parser.add_argument("trucks", type=int, help="")

def main(args : argparse.Namespace, args2 : argparse.Namespace):

    with open(args.output, mode="w") as f:
        run(args,list(map(str,[rel("dlgen"), args.seed, *args.rest])),
            stdout=f)
