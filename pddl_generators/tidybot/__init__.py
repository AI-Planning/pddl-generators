...
parser.add_argument("worldsize",    type=int, help="")
parser.add_argument("tables",       type=int, help="")
parser.add_argument("cupboards",    type=int, help="")
parser.add_argument("mintablesize", type=int, help="")
parser.add_argument("maxtablesize", type=int, help="")
parser.add_argument("cupboardsize", type=int, help="")

def main(args : argparse.Namespace, args2 : argparse.Namespace):

    with open(args.output, mode="w") as f:
        run(args,list(map(str,["python3", rel("gentidy.py"), *args.rest, args.seed])),
            stdout=f)
