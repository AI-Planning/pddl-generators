...
parser.add_argument("couples", type=int, help="the number of ")
parser.add_argument("cars", type=int, help="the number of ")
parser.add_argument("places", type=int, help="the number of ")


def main(args : argparse.Namespace, args2 : argparse.Namespace):

    with open(args.output, mode="w") as f:
        run(args,list(map(str,["python3", rel("generator.py"), *args.rest, args.seed])),
            stdout=f)
