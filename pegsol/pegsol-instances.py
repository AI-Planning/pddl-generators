...
pegs = [11,  5,  6,  7, 11, 10,  8,  8,  8,  9,
         7,  8, 10,  6,  7,  7, 10,  9, 12, 12,
         7,  8,  8,  8,  7,  7,  8,  8,  8, 16,
        19, 11, 14, 10, 12, 15, 11, 10, 13, 15,
        14, 13, 10, 17, 10,  8, 18,  9,  9,  9,
        15, 10, 11, 12, 14, 11,  8,  9,  9, 16,
        11, 13, 16, 12, 17, 12, 13, 12, 18, 15,
        19, 19, 16, 25,  9, 12, 10, 12,  8, 17,
        13, 10, 13, 23, 16, 12, 16, 13, 11, 22,
        19, 17, 17, 12, 17, 15, 13, 21, 28, 16,
        10, 12, 9, 20, 32, ]

unsolvable = [22, 23, 25, 27, 28, 29, 35, 38, 43, 45,
              49, 50, 57, 59, 69, 72, 76, 77, 79, 81,
              83, 86, 89, 90, 91, 94, 95, 96, 98, 100,
              103]

def report(instances):
    instances_and_pegs = [(instance, pegs[instance - 1])
