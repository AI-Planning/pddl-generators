...
from cmd_line import ArgProcessor, ArgDefinition, FlagDefinition,\
    range_validator, seq_range_validator, enum_validator, bool_validator,\
    InputException
...
def process_args():
    ...
    arg_processor.add_program_arg('-domain_file',
        ArgDefinition('domain_file_name',
            False, None, None, None,
            "The output PDDL domain file"))

    arg_processor.add_program_arg('-problem_file',
        ArgDefinition('problem_file_name',
            True, None, None, None,
            "The output PDDL problem file"))

    arg_processor.add_program_arg('-problem_name',
        ArgDefinition('problem_name',
            True, None, None, None,
            "The name of the problem instance"))

    arg_processor.add_program_arg('-cave_branches',
        ArgDefinition('cave_branches',
            False,
            seq_range_validator,
    ...
    arg_processor.add_program_arg('-objectives',
        ArgDefinition('objectives',
            False,
            seq_range_validator,
    ...
    arg_processor.add_program_arg('-num_tank_adjustment',
        ArgDefinition('num_tank_adjustment',
            False,
            range_validator,
    ...
    arg_processor.add_program_arg('-num_diver_adjustment',
        ArgDefinition('num_diver_adjustment',
            False,
            range_validator,
    ...
    arg_processor.add_program_arg('-neg_link_prob',
        ArgDefinition('neg_link_prob',
            False,
            range_validator,
    ...
    arg_processor.add_program_arg('-neg_cycle_length',
        ArgDefinition('neg_cycle_length',
            False,
            range_validator,
    ...
    arg_processor.add_program_arg('-minimum_hiring_cost',
        ArgDefinition('minimum_hiring_cost',
            False,
            range_validator,
    ...
    arg_processor.add_program_arg('-maximum_hiring_cost',
        ArgDefinition('maximum_hiring_cost',
            False,
            range_validator,
    ...
    arg_processor.add_program_arg('-perturb_hiring_costs',
        ArgDefinition('perturb_hiring_costs',
            False,
            range_validator,
    ...
    arg_processor.add_program_arg('-other_action_cost',
        ArgDefinition('other_action_cost',
            False,
            range_validator,
    ...
    arg_processor.add_program_arg('-strips',
        ArgDefinition('strips',
            False,
            bool_validator,
    ...
    arg_processor.add_program_arg('-order_tanks',
        ArgDefinition('order_tanks',
            False,
            bool_validator,
    ...
    try:
        ...
        if len(arg_processor.objectives) > len(arg_processor.cave_branches):
            raise InputException("Not enough cave branches for number of photo targets.")
